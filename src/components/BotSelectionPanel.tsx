            ...
            <div className="space-y-4 animate-in slide-in-from-right-8 duration-300">
                ...
                <div className="bg-[#1e293b]/50 rounded-2xl p-4 border border-white/5 space-y-4">
                     <div className="grid grid-cols-1 gap-4">
                         ...
                         <div>
                             <label className="text-[10px] font-black text-[#5ec2f2] uppercase tracking-widest mb-2 flex items-center justify-between">
                             ...
                             <div className="relative">
                                 <button 
                                    onClick={() => setIsOpeningListOpen(!isOpeningListOpen)}
                                                className={`w-full h-11 border rounded-xl px-3 text-left text-xs font-bold flex items-center justify-between transition-all ${isOpeningListOpen || selectedOpening ? 'bg-[#5ec2f2]/10 border-[#5ec2f2] text-[#0b0f1a]' : 'bg-[#0f172a] border-white/10 text-slate-400 hover:border-white/30'}`}
                                 >
                                     <div className="flex items-center gap-2">
                                        <BookOpen size={14} className={selectedOpening ? "text-[#5ec2f2]" : "opacity-50"} />
                                 ...
                                 {isOpeningListOpen && (
                                     <div className="absolute top-full left-0 right-0 mt-2 bg-[#0f172a] border border-white/10 rounded-xl shadow-2xl z-50 max-h-56 overflow-y-auto custom-scrollbar p-1">
                                         <input 
                                            ...
                                            placeholder="Search..." 
                                            autoFocus
                                            className="w-full bg-[#1e293b] border-none rounded-lg p-2 text-xs font-bold text-[#0b0f1a] placeholder:text-[#0b0f1a]/70 mb-1 focus:ring-1 focus:ring-[#5ec2f2]"
                                            value={openingSearch}
                                         ...
                                         {filteredOpenings.map(op => (
                                             <button key={op.id} onClick={() => { setSelectedOpening(op); setIsOpeningListOpen(false); }} className="w-full text-left px-3 py-2 text-xs font-bold text-[#0b0f1a] hover:bg-white/5 rounded-lg flex justify-between group">
                         ...
                         {/* Side Selection */}
                         <div>
                             <label className="text-[10px] font-black text-[#5ec2f2] uppercase tracking-widest mb-2 block">Play As</label>
