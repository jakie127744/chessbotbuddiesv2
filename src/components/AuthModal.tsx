...
export function AuthModal({ isOpen, onSuccess, onClose }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto">
      <div className="relative w-full max-w-md bg-[#243354] rounded-3xl shadow-2xl flex flex-col my-auto max-h-[95vh] animate-in slide-in-from-bottom-8 duration-500 border-4 border-[#69e0a3]/30">
        ...
        <div className="overflow-y-auto custom-scrollbar w-full h-full"> 
            ...
            <div className="pt-8 pb-8 px-6 md:px-8 relative z-0 flex flex-col items-center">
                ...
                <div className="mb-6 relative z-10 p-1 bg-[#243354] rounded-full shadow-lg">
                    <Mascot size={64} />
                </div>
                ...
                <div className="space-y-3">
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1a2744] border-2 border-[#3a4a6e] rounded-xl py-3 pl-12 pr-4 text-white font-bold focus:outline-none focus:border-emerald-500 focus:bg-[#243354] transition-all placeholder:text-[#6b7a99] text-sm md:text-base"
                    />
                  </div>
                  ...
                  {mode === 'register' && (
                      <div className="relative group animate-in slide-in-from-top-3 fade-in">
                          ...
                          <select
                              ...
                              className="w-full bg-[#1a2744] border-2 border-[#3a4a6e] rounded-xl py-3 pl-12 pr-4 text-white font-bold focus:outline-none focus:border-emerald-500 focus:bg-[#243354] transition-all appearance-none cursor-pointer text-sm md:text-base"
                          >
                              {COUNTRIES.map((c) => (
