  ...
  return (
    <div className="absolute inset-0 bg-[var(--surface)] border-r border-[var(--border)] flex flex-col z-20 animate-in slide-in-from-left-10 duration-200">
      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center custom-scrollbar bg-[var(--surface)]">
          ...
          {/* Description */}
           <div className="w-full bg-[var(--surface-highlight)] p-5 rounded-xl border border-[var(--border)] mb-6 shadow-sm">
             <p className="text-lg text-[var(--text-secondary)] leading-relaxed italic text-center">
               "{bot.description}"
             </p>
          </div>
      ...
      <div className="p-4 border-t border-[var(--border)] bg-[var(--surface)] shrink-0">
          <button 
            ...
            className="w-full py-4 text-xl font-black bg-jungle-green-500 hover:bg-jungle-green-400 text-[#0b0f1a] rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all active:translate-y-0"
          >
