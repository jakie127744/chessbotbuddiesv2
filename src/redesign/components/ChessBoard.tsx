...
export function ChessBoard({ 
    ...
    return (
        ...
        >
            ...
            >
                <div 
                    className="grid grid-cols-8 grid-rows-8 w-full h-full relative z-10 focus:outline-none focus:ring-4 focus:ring-blue-500/50"
                    tabIndex={0}
                    role="grid"
                            ...
                            return (
                                <div
                                    ...
                                    className={twMerge(
                                        ...
                                        isSelected && "bg-[#fff9c4]/35 ring-inset ring-4 ring-[#eab308]",
                                ...
                                >
                                    ...
                                    {square && (
                                        <img
                                            ...
                                            className={twMerge(
                                                "w-[85%] h-[85%] select-none cursor-pointer hover:scale-110 transition-transform z-10",
                                                square.color === 'w' ? "drop-shadow-lg" : "",
                                                !arePiecesDraggable && "cursor-default hover:scale-100"
                                            )}
                                    ...
                                    {fileIndex === 0 && (
                                        <span className={twMerge(
                                            ...
                                            isDark ? "text-[var(--color-text-primary)]" : "text-[var(--color-info)]"
                                        )}>
                                            {orientation === 'black' ? rankIndex + 1 : 8 - rankIndex}
                                        </span>
                                    )}
                                    {rankIndex === 7 && (
                                        <span className={twMerge(
                                            ...
                                            {orientation === 'black' ? String.fromCharCode(104 - fileIndex) : String.fromCharCode(97 + fileIndex)}
                                        </span>
                                    )}
                                </div>
                            );
