          ...
          <div className="flex flex-col items-center justify-center h-full p-6 bg-slate-900 text-white animate-fade-in">
              <div className="mb-8 text-center">
                  <div className="flex justify-center mb-4">
                      <Zap size={64} className="text-jungle-green-400" />
                  </div>
                  <h1 className="text-4xl font-black mb-2 bg-gradient-to-r from-jungle-green-400 to-jungle-green-700 bg-clip-text text-transparent">
                      PUZZLE SPRINT
                  </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl mb-12">
                  <button 
                    onClick={() => startGame('5min')}
                                        className="group relative overflow-hidden bg-slate-800 p-8 rounded-2xl border-2 border-slate-700 hover:border-jungle-green-500 transition-all hover:shadow-[0_0_20px_rgba(16,185,129,0.25)]"
                  >
                                            <div className="absolute top-0 right-0 p-4 opacity-50 font-black text-6xl text-slate-800 group-hover:text-jungle-green-500/10 transition-colors">5</div>
                                            <h3 className="text-2xl font-bold mb-2 text-jungle-green-300">5 Minutes</h3>
                      <p className="text-slate-400 text-sm">Balanced speed run. The classic test.</p>
                  </button>

                  <button 
                    onClick={() => startGame('10min')}
                                        className="group relative overflow-hidden bg-slate-800 p-8 rounded-2xl border-2 border-slate-700 hover:border-jungle-green-600 transition-all hover:shadow-[0_0_20px_rgba(5,150,105,0.3)]"
                  >
                                            <div className="absolute top-0 right-0 p-4 opacity-50 font-black text-6xl text-slate-800 group-hover:text-jungle-green-600/10 transition-colors">10</div>
                                            <h3 className="text-2xl font-bold mb-2 text-jungle-green-200">10 Minutes</h3>
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-6 bg-slate-900 text-white animate-fade-in relative overflow-hidden">
             ...
             <div className="z-10 text-center max-w-lg w-full">
                 ...
                 <div className="text-2xl text-slate-400 mb-10">Final Score: <span className="text-jungle-green-400 font-bold">{score}</span></div>
                 ...
                 <div className="bg-slate-800/50 rounded-2xl p-6 mb-8 border border-slate-700">
                     <div className="grid grid-cols-2 gap-8 text-center">
                         ...
                         <div>
                             ...
                             <div className="text-xl font-bold text-jungle-green-300">+{score * 5 + 20}</div>
                         </div>
                     </div>
                 </div>
            ...
            {mode !== 'survival' && (
                <div className={`bg-slate-800 rounded-2xl p-6 mb-6 border border-slate-700 shadow-xl ${timeLeft <= 10 ? 'animate-pulse border-red-500/50' : ''}`}>
                    <div className="flex items-end justify-between mb-2">
                        ...
                        <Timer size={20} className={timeLeft <= 30 ? 'text-red-500' : 'text-jungle-green-400'} />
                    </div>
                    <div className={`text-4xl font-mono font-bold ${timeLeft <= 30 ? 'text-red-400' : 'text-jungle-green-300'}`}>
                        {formatTime(timeLeft)}
                    </div>
                </div>
            )}
