...
const JAKIE_COMMENTARY: BotCommentaryData = {
    ...
    lines: {
        ...
        opening_specific: [
            "{opening}? Excellent choice. Let's explore the theory.",
            "Ah, {opening}. Remember the key principles here.",
            "{opening} creates dynamic imbalances. Be careful.",
            "I have many lessons prepared for {opening}."
        ],
        time_pressure_bot: [
